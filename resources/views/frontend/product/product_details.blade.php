                ...
                <div class="row mb-50 mt-30">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <h6> Sold By <a href="#"> <span class="text-danger"> eZimConnect </span> </a></h6>
                            @else
                ...
                <div class="product-info">
                    <div class="tab-style3">
                        <ul class="nav nav-tabs text-uppercase">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="Vendor-info-tab" data-bs-toggle="tab" href="#Vendor-info">Shop</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    ...
                                    <div class="vendor-name ml-15">
                                        @if($product->vendor_id == NULL)
                                        <h6>
                                            <a href="vendor-details-2.html">eZimConnect</a>
                                        </h6>
                                        @else
                                        <h6>
                                ...
                                <ul class="contact-infor mb-50">
                                    @if($product->vendor_id == NULL)
                                    <ul class="contact-infor mb-50">
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong> <span>eZimConnect</span></li>
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Contact Seller:</strong><span>eZimConnect</span></li>
                                    </ul>
                                    @else
                                    <ul class="contact-infor mb-50">
                                    ...
                                    @else
                                    <p>{{ $product['user']['vendor_short_info'] }}</p>
                                    @endif
                            </div>
