...
<div class="row">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
        ...
        <img id="showImage" src="{{ (!empty($userData->photo)) ? url('upload/' . $folderPath . '/' . $userData->photo):url('upload/no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
    </div>
