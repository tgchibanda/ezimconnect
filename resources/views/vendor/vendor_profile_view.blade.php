                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{  (!empty($vendorData->photo)) ? asset('upload/vendor_images/'.$vendorData->photo) : asset('upload/no_image.jpg') }}" alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">{{ (!empty($vendorData->website)) ? $vendorData->website : 'Not available' }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">{{ (!empty($vendorData->instagram)) ? $vendorData->website : 'Not available' }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">{{ (!empty($vendorData->facebook)) ? $vendorData->website : 'Not available' }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <form method="post" action="{{ route('vendor.profile.store') }}" enctype="multipart/form-data" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input disabled type="text" class="form-control" value="{{ $vendorData->username }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" name="mobile" class="form-control" value="{{ $vendorData->phone }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <option value="2024" {{ $vendorData->vendor_join == 2025 ? 'selected' : '' }}>2025</option>
									<option value="2025" {{ $vendorData->vendor_join == 2026 ? 'selected' : '' }}>2026</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <textarea class="form-control" id="vendor_short_info" name="vendor_short_info" placeholder="Address..." rows="3">{{ $vendorData->vendor_short_info }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="website" class="form-control" value="{{ $vendorData->website }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="instagram" class="form-control" value="{{ $vendorData->instagram }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="facebook" type="text" class="form-control" value="{{ $vendorData->facebook }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{  (!empty($vendorData->photo)) ? asset('upload/vendor_images/'.$vendorData->photo) : asset('upload/no_image.jpg') }}" alt="Vendor" style="width: 100px; height: 100px">
                                    </div>
                                </div>
